...
var verif_message = 0;
		...
		function jsoncallback(data){
			...
			// Message.
			if (data[1] && data[1]['ville'])
				verif_message = data[1]['ville'];
			else
				verif_message = -1;
		}
...
//								$form.reset();
							...
							{
								$form.reset();
								$message._show('failure', 'Code postal inexistant');
							}
							else if (verif_message.length > 1)
								$message._show('success', verif_message);
